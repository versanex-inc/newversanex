...
const projectSchema = new mongoose.Schema(
  {
    ...
    category: {
      type: String,
      required: [true, "Category is required"],
      // Active categories shown on frontend: website-developing, mobile-app-development, ui-ux
      // Hidden from frontend/admin but kept in enum so existing DB documents stay valid.
      enum: [
        "website-developing",
        "mobile-app-development",
        "ui-ux",
        "graphic-designing",             // HIDDEN
        "video-editing",                 // HIDDEN
        "content-writing",               // HIDDEN
        "digital-marketing",             // HIDDEN
        "software-quality-assurance",    // HIDDEN
      ],
    },
    subCategory: {
      type: String,
