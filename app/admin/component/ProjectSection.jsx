...
//                   <option value="software-quality-assurance">Qualuty Insurence</option>
//                 </select>
//               </div>
// {/* "graphic-designing",
//     "website-developing",
...
//       let newFormData = { ...formData, category: newCategory };
//       const disabled = disabledFieldsByCategory[newCategory] || [];
//       disabled.forEach(field => {
//         newFormData[field] = field === 'galleryUrls' ? [] : '';
//       });
...
//                   placeholder="React, Node.js, etc."
//                   className="w-full px-4 py-2 border border-amber-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent"
//                   disabled={disabledFields.includes('skills')}
//                 />
//               </div>
...
//                   placeholder="Dark mode, animations, etc."
//                   className="w-full px-4 py-2 border border-amber-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent"
//                   disabled={disabledFields.includes('features')}
//                 />
//               </div>
//             </div>
...
//                     }}
//                     className="px-4 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-colors"
//                     disabled={disabledFields.includes('creatorPicture')}
//                   >
//                     Upload
//                   </button>
//                   <input
...
//                   placeholder="https://example.com"
//                   className="w-full px-4 py-2 border border-amber-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent"
//                   disabled={disabledFields.includes('liveLink')}
//                 />
//               </div>
...
//                   placeholder="https://github.com/example"
//                   className="w-full px-4 py-2 border border-amber-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent"
//                   disabled={disabledFields.includes('repoLink')}
//                 />
//               </div>
//             </div>
//           </div>
...
//                 }}
//                 className="px-4 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-colors"
//                 disabled={disabledFields.includes('imageUrl')}
//               >
//                 Upload Main Image
//               </button>
//               {formData.imageUrl && (
...
//                 }}
//                 className="px-4 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-colors"
//                 disabled={disabledFields.includes('galleryUrls')}
//               >
//                 Upload Gallery Images
//               </button>
//               <div className="mt-2 grid grid-cols-4 gap-4">
...
useEffect(() => {
  ...
  const ProjectModal = ({ project, onClose }) => {
    ...
    const addGalleryUrl = () => {
      setFormData({ ...formData, galleryUrls: [...formData.galleryUrls, ''] });
    };
          ...
          <div className="mt-8 space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-amber-700 mb-1">
                {formData.category === 'video-editing' ? 'Gallery Videos' : 'Gallery Images'}
              </label>
              {!disabledFields.includes('galleryUrls') ? (
                formData.category === 'video-editing' ? (
                  <div className="space-y-2">
                    {formData.galleryUrls.map((url, index) => (
                      <div key={index} className="flex items-center gap-2">
                        <input
                          ...
                          className="flex-1 px-4 py-2 border border-amber-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                        />
                        <button onClick={() => removeGalleryImage(index)} className="text-red-600 hover:text-red-800">
                          <FaTimes />
                        </button>
                      </div>
                    ))}
                    <button
                      ...
                      className="px-4 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-colors"
                    >
                      <FaPlus className="inline mr-1" /> Add Video URL
                    </button>
                  </div>
                ) : (
                  <>
