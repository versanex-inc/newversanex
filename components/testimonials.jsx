...
//                         <Star
//                           key={idx}
//                           className={`w-4 h-4 ${idx < t.rating ? "text-yellow-400 fill-yellow-400" : "text-gray-300"}`}
//                         />
//                       ))}
//                     </div>
...
//             <button
//               className="testimonial-button-prev p-3 bg-white text-gray-600 rounded-full border shadow hover:shadow-lg hover:scale-110 transition-all duration-300"
...
//             <button
//               className="testimonial-button-next p-3 bg-yellow-400 text-white rounded-full shadow hover:shadow-lg hover:scale-110 transition-all duration-300"
...
//     >
//       <div className="max-w-7xl mx-5 px-4 relative z-10">
//         <SectionHeading eyebrow="Client Reviews" title="What Our Clients Say" />
