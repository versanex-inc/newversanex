...
//                 <p className="text-gray-600 text-xs sm:text-sm">{project.deadline ? new Date(project.deadline).toLocaleDateString() : "N/A"}</p>
//               </div>
//             </div>
//             <div className="flex items-start gap-2 sm:gap-3">
...
//               <span
//                 key={tech}
//                 className="flex items-center gap-1 px-2 py-1 rounded-full bg-gradient-to-r from-teal-100 via-emerald-50 to-cyan-100 text-teal-800 text-xs sm:text-sm border border-teal-200"
//               >
//                 <Tag className="h-3 w-3" />
//                 {tech}
//               </span>
...
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className="flex items-center gap-1.5 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg bg-gradient-to-r from-teal-600 to-emerald-500 text-white hover:shadow-md hover:scale-[1.02] transition-all text-sm sm:text-base"
//               >
//                 <ExternalLink className="h-4 w-4" />
//                 <span>Live Demo</span>
//               </Link>
...
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className="flex items-center gap-1.5 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg bg-gradient-to-r from-gray-800 to-gray-900 text-white hover:shadow-md hover:scale-[1.02] transition-all text-sm sm:text-base"
//               >
//                 <Github className="h-4 w-4" />
//                 <span>View Code</span>
//               </Link>
...
//         <motion.div
//           variants={fadeIn}
//           className="bg-gradient-to-br from-teal-50 via-emerald-50 to-cyan-50 rounded-xl p-4 sm:p-6 border border-teal-100"
//         >
//           <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-gray-800">Project Details</h3>
//           <div className="space-y-3 sm:space-y-4">
//             <div className="flex items-start gap-2 sm:gap-3">
...
//             <div
//               key={index}
//               className="bg-gradient-to-br from-teal-50 via-emerald-50 to-cyan-50 border border-teal-100 rounded-lg p-3 sm:p-4 flex items-start gap-2 sm:gap-3 hover:shadow-md hover:border-teal-300 transition-all"
//             >
//               <div className="flex-shrink-0 w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-gradient-to-tr from-teal-500 to-emerald-400 flex items-center justify-center text-white text-xs sm:text-sm shadow-sm">
//                 {index + 1}
//               </div>
