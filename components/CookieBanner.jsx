...
//             className="fixed bottom-0 left-0 right-0 z-[9999] bg-white shadow-lg border-t border-gray-200 p-4 md:p-6"
//           >
...
//               exit={{ y: "100%", opacity: 0 }}
//               transition={{ duration: 0.5, ease: "easeOut" }}
//               className="fixed bottom-4 left-1/2 -translate-x-1/2 z-[9999] bg-white rounded-2xl shadow-2xl p-6 max-w-6xl w-[90%]"
//             >
